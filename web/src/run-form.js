export function toRunConfig({ targetId, mode, vus, rps, duration, prompt, maxTokens, maxErrorPercent, maxP95Millis, cachePolicy = "mixed", variationPercent = "30", shards = "1", maxTTFTP95Millis = "0", minOutputTokensPerSecond = "0" }) {
